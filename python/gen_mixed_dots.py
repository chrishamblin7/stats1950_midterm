...
#size_styles = ['random', 'dotareacontrol','totalareacontrolsame','totalareacontroldifferent']
#color_styles = ['bow','wob','greyrandom','greysingle','colorrandom','colorsingle']
size_styles = ['dotareacontrol','totalareacontroldifferent']
color_styles = ['wob','greysingle','colorsingle']
...
outputfile.write("image name    %s"%'    '.join(column_names))
outputfile.flush()
